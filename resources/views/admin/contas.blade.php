        ...
        <div class="row mb-3">
            <div class="col-md-12">
                <div class="overview-wrap">
                    <h2 class="title-1">Conta Clientes</h2>
            ...
            @if(isset($contas))
                ...
                <tr>
                    ...
                    <td class="d-flex justify-content-center"> 
                         <button class="btn btn-sm btn btn-success mr-1" id=""  onclick="retornaid({{$c->codigo}})" data-toggle="modal" data-target="#registarusuarioModal">
                           Movimentar
                        </button>

                        <button class="btn btn-sm btn btn-info mr-1" id="" >
                            <a class="bnEditar" href="{{url("/dashboard/contas/detalhes/$c->codigo")}}">Histórico</a>
                        </button>
