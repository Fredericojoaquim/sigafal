        ...
        <div class="row mb-3">
            <div class="col-md-12">
                <div class="text-center">
                    <h2 class="title-1">Pagamento</h2> <br> <br>
                </div>
            </div>
        </div>
            ...
            <div class="container">
                ...
                <div class="row">
                  <div class="col-md-4">
                        ...
                        Dívida: <label style="color:black" class=" form-control-label">{{number_format($qtd*$valorPagar, 2,",",".")}} </label><br>
                    ...
                    <form action="{{url('/dashboard/pagamentos/gerar-codigo-fatura')}}" method="Post"  novalidate="novalidate" id="form_pag">
                        ...
                        <div class="row">
                            <div class="col-6">
                                ...
                                <select onchange="gerarNumero()" name="modo_pagamento" id="modo_pagamento" class="form-control required">
